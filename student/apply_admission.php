...
<body>
    ...
    <script>
        ...
        function generateReview() {
            ...
            html += `<p><strong>Calculated Merit Score:</strong> ${meritScore}</p>`;
            
            html += '<h4 style="margin-top: 20px;">Uploaded Documents</h4>';
            html += `<p>✓ Passport Photo: ${document.getElementById('photo').files[0]?.name || 'Not uploaded'}</p>`;
            html += `<p>✓ CNIC Front: ${document.getElementById('cnic_front').files[0]?.name || 'Not uploaded'}</p>`;
            html += `<p>✓ CNIC Back: ${document.getElementById('cnic_back').files[0]?.name || 'Not uploaded'}</p>`;
            html += `<p>✓ Matric Result: ${document.getElementById('matric_result').files[0]?.name || 'Not uploaded'}</p>`;
            html += `<p>✓ Intermediate Result: ${document.getElementById('inter_result').files[0]?.name || 'Not uploaded'}</p>`;
        ...
        document.getElementById('applicationForm').addEventListener('submit', function(e) {
            ...
            const requiredFiles = ['photo', 'cnic_front', 'cnic_back', 'matric_result', 'inter_result'];
